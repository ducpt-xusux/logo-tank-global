        ...
        <DialogPortal data-slot="dialog-portal">
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    ...
                    "data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-[300] grid w-full max-w-[calc(100%-2rem)]",
            ...
            >
                ...
                {showCloseButton && (
                    <DialogPrimitive.Close
                        ...
                        className={cn(
                            "ring-offset-background focus:ring-ring data-[state=open]:bg-neutral-100",
