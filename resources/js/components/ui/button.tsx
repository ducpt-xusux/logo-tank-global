...
const buttonVariants = cva(
    cn(
        ...
        "[&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50",
    ...
    ),
    {
        variants: {
            variant: {
                ...
                success:
                    "bg-teal-600 text-white shadow-xs hover:bg-teal-700 focus-visible:ring-teal-500/20 dark:focus-visible:ring-teal-500/40",
                outline:
                    "border border-neutral-200 bg-background shadow-xs hover:bg-neutral-100 hover:text-neutral-900",
                secondary:
