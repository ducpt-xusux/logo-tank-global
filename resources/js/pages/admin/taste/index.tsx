...
const breadcrumbs = [
    {
        title: "テイスト",
        href: route("admin.taste.index"),
    },
];
interface TasteIndexProps {
    items: ItemsProps;
    params: ParamsProps;
}
...
const columns: ColumnDef<any>[] = [
...

    {
        accessorKey: "name",
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="テイスト" />
        ),
...

    {
        ...
        accessorKey: "id",
        header: ({ column }) => null,
        cell: ({ row }) => <DataTableRowActions row={row} model="taste" />,
    },
];

export default function TasteIndex({ items, params }: TasteIndexProps) {
